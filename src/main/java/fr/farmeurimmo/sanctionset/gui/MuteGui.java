...
public class MuteGui {
    ...
    public static void mutegui(Player player, String cible) {
        if (player.hasPermission("mod")) {
            Inventory inv = Bukkit.createInventory(null, 27, "§4SanctionSet Mutes");

            ItemStack custom1 = new ItemStack(Material.BOW, 1);
            ItemMeta customS = custom1.getItemMeta();
            customS.setDisplayName("§6" + SanctionMain.instance.getConfig().getString("SanctionSet.Settings.Menu.Mutes.Bow.Reason"));
            ...
            customa.setDisplayName("§6" + SanctionMain.instance.getConfig().getString("SanctionSet.Settings.Menu.Mutes.DiamondSword.Reason"));
            ...
            customb.setDisplayName("§6" + SanctionMain.instance.getConfig().getString("SanctionSet.Settings.Menu.Mutes.Anvil.Reason"));
            ...
            customc.setDisplayName("§6" + SanctionMain.instance.getConfig().getString("SanctionSet.Settings.Menu.Mutes.RedstoneBlock.Reason"));
            ...
            customf.setDisplayName("§6" + SanctionMain.instance.getConfig().getString("SanctionSet.Settings.Menu.Mutes.ActivatorRail.Reason"));
            ...
            customg.setDisplayName("§6" + SanctionMain.instance.getConfig().getString("SanctionSet.Settings.Menu.Mutes.ArmorStand.Reason"));
            ...
            customh.setDisplayName("§6" + SanctionMain.instance.getConfig().getString("SanctionSet.Settings.Menu.Mutes.Compass.Reason"));
            ...
            customi.setDisplayName("§6" + SanctionMain.instance.getConfig().getString("SanctionSet.Settings.Menu.Mutes.FlintAndSteel.Reason"));
